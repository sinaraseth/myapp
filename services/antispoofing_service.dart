...
class AntispoofingService {
  ...
  Future<void> loadModel() async {
    try {
      ...
      final modelPath = '${tempDir.path}/antispoofing.onnx';

      final modelFile = File(modelPath);
      if (!await modelFile.exists()) {
        final modelData = await rootBundle.load('assets/antispoofing.onnx');
  ...
  Future<AntispoofingResult> predict(File imageFile) async {
    ...
    try {
      ...
      final ortValue = OrtValueTensor.createTensorWithDataList(inputTensor, shape);
